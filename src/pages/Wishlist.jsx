    ...
    return (
        <div>
            ...
            <div className={`${themeClass} px-total py-[50px]`}>
                ...
                {(productWishlist.length===0 && Array.isArray(productWishlist)) && <div className='w-[100%] text-center py-[30px] text-darkGray font-bold flex flex-col items-center gap-[20px]'>Your Wishlist is Empty</div>}
