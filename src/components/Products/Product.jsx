...
function Product({ product }) {
    ...
    if (operand === "-")
      ...
      if (counter < Number(product.stock))
        ...
        setToastState((old) =>
          addItemOnce(old.slice(), {
            title: "2",
            description: "Your request is more than stock",
            key: Math.random(),
          })
        );
      }
  ...
  useEffect(() => {
    if (doneRequest === 1) setFirstLoad(0);
  }, [doneRequest]);
      ...
      <div className="flex lg:flex-col lg:items-center lg:gap-[20px] lgmin:flex-row lgmin:justify-between flex-wrap">
        <div className="sm:w-[90%] lg:w-[70%] lgmin:w-[48%] flex flex-col gap-[20px]">
          {textButton !== "" ? (
            <>
              <div
                className={` bg-[length:100%_100%] bg-no-repeat w-[100%] mm:h-[350px] sm:h-[450px] md:h-[550px] lg:h-[700px] lgmin:h-[750px]`}
          ...
          <div>
            {textButton !== "" ? (
              <>
                ...
                <i
                  className="fa fa-heart text-red pb-[5px]"
            ...
            {textButton !== "" ? (
              <>
                <h3>
                  <strike className="text-[14px] text-darkGray">
                    ${product.price}
                  </strike>
                  <span className="text-red"> {product.off}% Off</span>
                </h3>
                <h3 className="text-[26px]">
                  ${(Number(product.price) * (100 - Number(product.off))) / 100}
                </h3>
              </>
            ) : (
