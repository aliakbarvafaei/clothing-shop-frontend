              ...
              <ul className="w-[100%] p-0">
                ...
                >
                  <Link to="#" className=" ml-[2rem] text-[2rem] no-underline">
                    <p className="text-[18px] font-bold text-right inline">
                      BACK NAVBAR{" "}
                    </p>
                    <i
                      style={{ fontSize: "20px" }}
                ...
                {items.map((item, index) => {
                  return (
                    <li
                      key={index}
                      className="hover:text-red text-[16px] font-bold flex flex-col items-start px-[15px] py-[10px] w-[100%] list-none cursor-text"
                    >
