    ...
    return (<>
        ...
        <div className={`${themeClass} fixed h-[100vh] top-0 left-0 w-[100%] z-[110]`}>
            <div className='relative w-[80%] top-[45%] left-[10%]'>
                <input type="text" placeholder='Search a Product' className={`${themeClass} w-[100%] focus:outline-none text-darkGray text-[20px] border-b-solid border-b-[2px] ${themeBorder} `}/>
                <i className="fa fa-search text-[25px] cursor-pointer absolute right-[1%]" aria-hidden="true"></i>
            </div>
        </div>
        </>
    );
