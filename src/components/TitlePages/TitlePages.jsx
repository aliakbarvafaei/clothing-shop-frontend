...
function TitlePages({title}) {
    ...
    const themeClass = theme.mode==="DARK" ? "bg-black text-lightGray": "bg-lightGray text-black";

    function handleCreate(){
        history.push("/home");
    }
    return ( 
        <div className={`${themeClass} mdmin:py-[40px] md:py-[20px] px-total bg-lightGray`}>
